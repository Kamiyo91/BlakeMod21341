...
{
    [HarmonyPatch]
    public class HarmonyPatch_Ka21341
    {
        [HarmonyPostfix]
        ...
        {
            if (ModParameters.PackageId != __instance.BookId.packageId) return;
        ...
        {
            if (force) return;
            if (newBook == null || ModParameters.PackageId != newBook.ClassInfo.id.packageId) return;
